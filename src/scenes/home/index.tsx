		...
		<section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
			...
			>
				...
				<div className="flex basis-3/5 justify-center md:z-10 md:ml-40 md:mt-16 md:justify-items-end">
					<img src={HomePageGraphic} alt="Home page graphice" />
				</div>
			</motion.div>
			{/* SPONSORS */}
			{isAboveMediumScreens && (
				<div className="h-[150px] w-full bg-primary-100 py-10">
					<div className="mx-auto w-5/6">
						<div className="flex w-3/5 item-center justify-between gap-8">
							<img src={SponsorRedBull} alt="Red bull sponsor" />
							<img src={SponsorForbes} alt="Fobes bull sponsor" />
							<img src={SponsorFortune} alt="Fortune bull sponsor" />
						</div>
					</div>
				</div>
			)}
